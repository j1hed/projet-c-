...
void gestion_eleve::on_pb_ajouter_clicked()
{
    ...
    Eleve E(ID,NOM, PRENOM, DATEN, SEXE, CLASSE);
...
void gestion_eleve::on_qrcodegen_clicked()
{
    using namespace qrcodegen;
                ...
                QString value=ui->lineEdit_qrcode->text();
                     ...
                     qry.prepare("select * from eleve where id='"+value+"'");
                     qry.exec();
                     Mod->setQuery(qry);
...
void gestion_eleve::on_PDF_clicked()
{
                            ...
                            QPdfWriter pdf("C:/Users/admin/Downloads/session_septembre/session_septembre/img/listdeseleves.pdf");
                                ...
                                QPainter painter(&pdf);
                                       ...
                                       painter.drawText(7500,3300,"CLASSE");
                                       ...
                                       QImage image1("C:/Users/admin/Downloads/session_septembre/session_septembre/img/photo2.jpg");
